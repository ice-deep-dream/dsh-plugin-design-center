window.__ModuleLoader__.load({
	id: "@cryodream/dsh-client-ui-design-center",
	factory: (require) => {
		var module = { exports: {} };
		...
		var DesignCenterView_module_css_default = {
			...
			"headerTitle": "kqBgzW_headerTitle",
		...
		function DesignCenterView(props) {
			...
			const activeDiagram = subTab === "architecture" ? architecture : subTab === "modules" ? modules : subTab === "flows" ? activeFlow : void 0;
			const activeDraft = activeDiagram ? state.drafts[activeDiagram.id] : void 0;
			const activeTitle = activeDiagram?.title || activeDiagram?.id || "";
			const saveDiagram = (d) => {
				controller.saveSpec(sessionId, d.id).then((ok) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: DesignCenterView_module_css_default.headerTitle,
							children: activeDiagram ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: DesignCenterView_module_css_default.diagramTitle,
								children: activeTitle
							}), activeDraft === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								size: "sm",
								variant: "ghost",
								onClick: () => controller.updateDraft(activeDiagram.id, activeDiagram.specText),
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									size: "sm",
									variant: "primary",
									onClick: () => saveDiagram(activeDiagram),
									children: t("toolbar.save")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									size: "sm",
									variant: "ghost",
									onClick: () => controller.clearDraft(activeDiagram.id),
									children: t("toolbar.cancel")
								})]
							})] }) : subTab === "plan" && board?.plan ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: DesignCenterView_module_css_default.planHeadTitle,
								children: [
									"开发计划 · v",
									board.plan.version ?? "1.0.0",
								...
								variant: "ghost",
								onClick: () => {
									controller.updatePlanDraft(board.plan?.text ?? "");
									setEditingPlan(true);
								},
								children: t("toolbar.edit")
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						board && subTab === "plan" ? (() => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: editingPlan ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
									className: DesignCenterView_module_css_default.editor,
